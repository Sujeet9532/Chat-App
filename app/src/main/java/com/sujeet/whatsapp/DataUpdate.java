...
public class DataUpdate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.setMessage("Data Changing...");
                                    ...
                                    reference.setValue(users).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if (task.isSuccessful()){
                                                ...
                                                Intent intent = new Intent(DataUpdate.this,MainActivity.class);
                                                startActivity(intent);
                                                finish();
                                            }else {
                                                progressDialog.dismiss();
                                                Toast.makeText(DataUpdate.this, "Some thing went romg", Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                    });
                                }
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            reference.setValue(users).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()){
                                        progressDialog.dismiss();
                                        Toast.makeText(DataUpdate.this, "Data Is save ", Toast.LENGTH_SHORT).show();
                                        Intent intent = new Intent(DataUpdate.this,MainActivity.class);
                                        startActivity(intent);
                                        finish();
                                    }else {
